...
class Customer { 
    ...
    function list_records() {
        ...
        echo "
            ...
            <body>
                <a href='https://github.com/kaidenmoore4/prog2_cis355/tree/master/Program2' target='_blank'>Github</a><br />
				<a href='img/flow.jpg' target='_blank'>Flow Chart</a><br />
				<a href='img/Untitled Diagram.jpg' target='_blank'>UML</a><br />
                <div class='container'>
                    <p class='row'>
                        <h3>$this->title" . "s" . "</h3>
                    </p>
